...
public class Schema {
    ...
    public Schema withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public Schema withCategory(Category category) {
        this.category = category;
        return this;
    }
    ...
    public Schema withPhotoUrls(List<String> photoUrls) {
        this.photoUrls = photoUrls;
        return this;
    }
    ...
    public Schema withTags(List<Tag> tags) {
        this.tags = tags;
        return this;
    }
    ...
    public Schema withStatus(String status) {
        this.status = status;
        return this;
    }
